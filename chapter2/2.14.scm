...
(define a1 (make-center-percent 1.0 0.5))
(define b1 (make-center-percent 1.0 2))
(display "a1=")
(display a1)
(newline)
(display (percent (mul-interval (mul-interval (div-interval one a1) a1) (mul-interval (div-interval one a1) a1))))
(newline)

(define (repeater fun arg1 arg2 i)
  (if (= i 1)
      (fun arg1 arg2)
      (repeater fun (fun arg1 arg2) (fun arg1 arg2) (- i 1))))

(display (percent (repeater mul-interval (div-interval one a1) a1 2)))
(newline)